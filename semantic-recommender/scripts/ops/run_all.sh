...
echo "----------------------------------------------------------------------"
python3 scripts/data_pipeline/parse_movielens.py
echo ""
...
python3 scripts/data_pipeline/generate_user_profiles.py
echo ""

echo "Generating platform data..."
python3 scripts/data_pipeline/generate_platform_data.py
echo ""
...
python3 scripts/data_pipeline/populate_milvus.py
echo ""

echo "Populating Neo4j graph database..."
python3 scripts/data_pipeline/populate_neo4j.py
echo ""

echo "Populating AgentDB RL policies..."
python3 scripts/data_pipeline/populate_agentdb.py
echo ""
